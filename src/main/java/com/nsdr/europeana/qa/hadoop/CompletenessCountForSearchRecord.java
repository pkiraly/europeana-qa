...
import com.nsdr.europeana.qa.metadata.europeana.SearchRecordMetadata;
...
public class CompletenessCountForSearchRecord {
	...
	public static class CompletenessMapper
		...
		static {
			...
			try {
				schema = new Schema(
					Paths.get(classLoader.getResource("edm-schema-search.txt").toURI()));
			} catch (URISyntaxException ex) {
				Logger.getLogger(CompletenessCountForSearchRecord.class.getName()).log(Level.SEVERE, null, ex);
			}
		}
		...
		public void map(LongWritable key, Text value, Context context)
			...
			if (json != null) {
				Metadata metadata = new SearchRecordMetadata(json);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CompletenessCountForSearchRecord.class);
